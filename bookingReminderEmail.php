<?php
$emailtitle = 'Booking Reminder at Lighthouse Restaurant';
$senderemail = 'info@lighthouserestaurant.co.uk';
$domainname = 'lighthouserestaurant.co.uk';
$business = 'Lighthouse Restaurant';

$customer_email = "This is a reminder of your reservation with us, on the <b>".date("jS F Y", $rd)."</b> at <b>".date('H:i',strtotime($tm))."</b> for <b>".$ps." ".($ps==1?'Person':'People')."</b><br />".
//($rq>''?"<b>Your notes with this booking were:</b><br />".$rq:"")."<br />".
($password>''||$_useraccountid>0?"To amend this booking (if required) or view your other bookings, please visit <a href='http://bookings.lighthouserestaurant.co.uk/account_login.php'>MyAccount</a>":"");
